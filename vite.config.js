  ...
  build: {
    rollupOptions: {
      input: {
        ...
        services: resolve(rootDirectory, "pages/services/index.html"),
        industries: resolve(rootDirectory, "pages/industries.html"),
        process: resolve(rootDirectory, "pages/process.html"),
        work: resolve(rootDirectory, "pages/work.html"),
        contact: resolve(rootDirectory, "pages/contact.html"),
      },
    },
  },
  server: {
